...
//		adc0val = (uint8_t)(adval & 0x000000FF);
		...
		msgAdcSD.Adc4Value = adval;

//		vTaskDelay( xDelay );
		//////////////////////////////////////////////////////////////////////////////

		xQueueSend(queueAdcSdCard,&msgAdcSD,1000);
