...
C_SRCS += \
../src/Tasks/Lcd/lcdgraficoFonts/lcd_buffer.c 

OBJS += \
./src/Tasks/Lcd/lcdgraficoFonts/lcd_buffer.o 

C_DEPS += \
./src/Tasks/Lcd/lcdgraficoFonts/lcd_buffer.d 


# Each subdirectory must supply rules for building sources it contributes
src/Tasks/Lcd/lcdgraficoFonts/%.o: ../src/Tasks/Lcd/lcdgraficoFonts/%.c
	@echo 'Building file: $<'
