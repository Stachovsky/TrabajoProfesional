...
void redLedBarSet (uint8_t ledOnMask){
	pca9532_setLeds (ledOnMask,0x00FF);
}

void greenLedBarSet (uint8_t ledOnMask){
	pca9532_setLeds ((uint16_t)flipbits(ledOnMask)<<8,0xFF00);
}
