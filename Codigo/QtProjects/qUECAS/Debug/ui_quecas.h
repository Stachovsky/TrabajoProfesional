...
**
** Created: Sat May 25 14:03:20 2013
...
public:
    ...
    QLineEdit *ADC2Value;
    QLabel *label_5;
    QSlider *ADC3ValueBar;
    QLineEdit *ADC3Value;
    QCheckBox *Actuador1;
    QCheckBox *Actuador3;
    QCheckBox *Actuador2;
    QLineEdit *ADC4Value;
    QSlider *ADC4ValueBar;
    QLabel *label_6;
    ...
    void setupUi(QMainWindow *qUECAS)
    {
        ...
        label_5 = new QLabel(tabComunicion);
        label_5->setObjectName(QString::fromUtf8("label_5"));
        label_5->setGeometry(QRect(430, 20, 41, 17));
        ADC3ValueBar = new QSlider(tabComunicion);
        ADC3ValueBar->setObjectName(QString::fromUtf8("ADC3ValueBar"));
        ADC3ValueBar->setEnabled(false);
        ADC3ValueBar->setGeometry(QRect(430, 40, 29, 160));
        ADC3ValueBar->setMaximum(4095);
        ADC3ValueBar->setOrientation(Qt::Vertical);
        ADC3Value = new QLineEdit(tabComunicion);
        ADC3Value->setObjectName(QString::fromUtf8("ADC3Value"));
        ADC3Value->setEnabled(false);
        ADC3Value->setGeometry(QRect(420, 200, 51, 27));
        ...
        ADC4Value = new QLineEdit(tabComunicion);
        ADC4Value->setObjectName(QString::fromUtf8("ADC4Value"));
        ADC4Value->setEnabled(false);
        ADC4Value->setGeometry(QRect(500, 200, 51, 27));
        ADC4ValueBar = new QSlider(tabComunicion);
        ADC4ValueBar->setObjectName(QString::fromUtf8("ADC4ValueBar"));
        ADC4ValueBar->setEnabled(false);
        ADC4ValueBar->setGeometry(QRect(510, 40, 29, 160));
        ADC4ValueBar->setMaximum(4095);
        ADC4ValueBar->setOrientation(Qt::Vertical);
        label_6 = new QLabel(tabComunicion);
        label_6->setObjectName(QString::fromUtf8("label_6"));
        label_6->setGeometry(QRect(510, 20, 41, 17));
    ...
    void retranslateUi(QMainWindow *qUECAS)
    {
        ...
        label_5->setText(QApplication::translate("qUECAS", "ADC3", 0, QApplication::UnicodeUTF8));
        ...
        label_6->setText(QApplication::translate("qUECAS", "ADC4", 0, QApplication::UnicodeUTF8));
